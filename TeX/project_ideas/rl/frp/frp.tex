...
Persona-based interventions have been empirically demonstrated to make models safer: they have increased jailbreak resistance, reduced the rate of learning undesirable behaviour \cite{inoculation_prompting}, and mitigated model psychosis \cite{lu2026assistantaxissituatingstabilizing}. %I think you can do better here and find cases where models become more transparent, and thus harder to deceptively align than in previous cases. Does sharan's paper talk about it?
