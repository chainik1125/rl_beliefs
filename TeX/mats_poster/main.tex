...
\vspace{0.05em}\\
\small{
\color{blue}\underline{dmanningcoe@gmail.com}\color{black}}\vspace{0.1em}\\
}
...
\begin{center}
\large\underline{\textbf{TL;DR: }}\textbf{We propose a simple theory of model personas and show that it can be used to replicate emergent misalignment in a tiny transformer.}
\end{center}
}
